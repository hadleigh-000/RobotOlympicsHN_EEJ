...
float vL, vR, totalDistanceLeft, totalDistanceRight, angleRadAccum;
...
/* ki =4140, kp = 408 */
  ...
  float vDes = kp*angleRad + ki*angleRadAccum;
  int pwmL = vDes;        //jp*(vDes-vL) + ji*(distDes - totalDistanceLeft); 
  int pwmR = vDes;        //jp*(vDes-vR) + ji*(distDes - totalDistanceRight); 
  if (pwmL > 300)
  {
    pwmL = 300;
    pwmR = 300;
